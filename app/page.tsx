    ...
    <main className="w-full">
      ...
      <section className="container mx-auto px-4 py-32">
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-black mb-6 text-6xl font-bold">Welcome to My Job Tracker</h1>
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="flex flex-col">
              ...
              <p className="text-muted-foreground">
                Create custom boards and colums to track your job applications at every stage of the process. Stay organized and never miss a deadline.
              </p>
              </div>
              <div className="flex flex-col">
              <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
